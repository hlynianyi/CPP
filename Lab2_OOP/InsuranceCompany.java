...
public class InsuranceCompany extends Organization{
    ...
    public InsuranceCompany(String name, String industry, String theFounder, int foundationYear,
                            String shortDescription, int numberOfEmployees, String location, String keyPersons, int equity,
                            int turnover, int netProfit, int actives, int capitalization) {
